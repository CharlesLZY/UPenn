...
protected:
    ...
    GLuint bufJoint; // A Vertex Buffer Object that we will use to store joint
    GLuint bufJointWeight; // A Vertex Buffer Object that we will use to store joint weights

    bool jointBound; // Set to TRUE by generateJoint(), returned by bindJoint().
