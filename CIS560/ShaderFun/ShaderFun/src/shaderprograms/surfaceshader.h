...
public:
    ...
    int unifCam; // A handle to the "uniform" vec3 representing your camera's position in world space
...
public:
    ...
    // Pass the camera position in world space to this shader on the GPU
